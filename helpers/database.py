...
class Database:
    """Enhanced MongoDB database handler with advanced features."""
    ...
    async def get_user_settings(self, user_id: int) -> Dict:
        ...
        try:
            ...
            return settings or self._default_settings()
    ...
    async def update_user_settings(self, user_id: int, settings: Dict) -> bool:
        ...
        try:
            ...
            settings["updated_at"] = asyncio.get_event_loop().time()
    ...
    async def increment_user_stats(self, user_id: int, merge_count: int = 1, size_processed: int = 0) -> bool:
    ...
    async def get_all_users(self) -> List[Dict]:
        ...
        try:
            ...
            users = await asyncio.to_thread(
                lambda: list(self.users.find({}, {"_id": 1, "name": 1}))
            )
            return users
